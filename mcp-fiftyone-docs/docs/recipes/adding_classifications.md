[ Run in Google Colab ](https://colab.research.google.com/github/voxel51/fiftyone/blob/main/docs/source/recipes/adding_classifications.ipynb) |  [ View source on GitHub ](https://github.com/voxel51/fiftyone/blob/main/docs/source/recipes/adding_classifications.ipynb) |  [ Download notebook ](https://raw.githubusercontent.com/voxel51/fiftyone/main/docs/source/recipes/adding_classifications.ipynb)
...
Youâll also need to install `torch` and `torchvision`, if necessary:
...
In this example, weâll work with the test split of the CIFAR-10 dataset, which is conveniently available for download from the [FiftyOne Dataset Zoo](https://voxel51.com/docs/fiftyone/user_guide/dataset_zoo/datasets.html#dataset-zoo-cifar10):
    ...
    Extracting /Users/Brian/fiftyone/cifar10/tmp-download/cifar-10-python.tar.gz to /Users/Brian/fiftyone/cifar10/tmp-download
     100% |âââ| 10000/10000 [5.7s elapsed, 0s remaining, 1.9K samples/s]
    Dataset info written to '/Users/Brian/fiftyone/cifar10/info.json'
    

Weâll also download a pre-trained CIFAR-10 PyTorch model that weâll use to generate some predictions:
    ...
    Downloading '1dGfpeFK_QG0kV-U6QDHMX2EOGXPqaNzu' to 'PyTorch_CIFAR10/cifar10_models/state_dicts/resnet50.pt'
     100% |ââââ|  719.8Mb/719.8Mb [2.7s elapsed, 0s remaining, 276.2Mb/s]
...
Building a [FiftyOne dataset](https://voxel51.com/docs/fiftyone/user_guide/using_datasets.html) from your samples in this format is simple:
    ...
    print(dataset)
     ...
     100% |âââââââââââââââââââ| 10000/10000 [44.9s elapsed, 0s remaining, 221.4 samples/s]
...
FiftyOne provides a powerful notion of [dataset views](https://voxel51.com/docs/fiftyone/user_guide/using_views.html) that you can use to explore subsets of the samples in your dataset. Hereâs an example operation:
...
Now letâs [add our classifierâs predictions](https://voxel51.com/docs/fiftyone/user_guide/using_datasets.html#classification) to our FiftyOne dataset in a new `predictions` field:
    ...
    with fo.ProgressBar() as pb:
     ...
     100% |âââââââââââââââââââââââââââ| 5/5 [1.4s elapsed, 0s remaining, 3.6 batches/s]
...
Letâs explore the predictions we added by creating a view that sorts the samples in order of prediction confidence:
...
The [FiftyOne App](https://voxel51.com/docs/fiftyone/user_guide/app.html) allows you easily visualize, explore, search, filter, your datasets. You can explore the App interactively through the GUI, and you can even interact with it in real-time from your Python interpreter!
...
Activate You can select samples in the App by clicking on the images. Try it! After youâve selected some images in the App, you can hop back over to Python and make a view that contains those samples!
